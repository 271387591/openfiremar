...
//        nvps.add(new BasicNameValuePair("manager", "1"));
     ...
     * 请求方式：POST/GET
     * 返回字段说明：
     * 见登陆返回的参数，有的参数可能为空，但不影响
     * @throws Exception      YE1986fa919hou867
     */

    @Test
    public void testGetUser() throws Exception{
        String url="http://120.24.234.71/im/app/getUser";
//        String url="http://localhost:9095/openfiremar/app/getUser";
        HttpPost httpost = new HttpPost(url);
        List<NameValuePair> nvps = new ArrayList<NameValuePair>();

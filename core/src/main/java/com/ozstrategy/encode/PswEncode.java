...
/**
 * Created by lihao on 12/11/14.
 */
public class PswEncode implements PasswordEncoder {
    private static final Logger Log = LoggerFactory.getLogger(PswEncode.class);
...
//        psw="536c0b339345616c1b33caf454454d8b8a190d6c";
     ...
     */
    public PswEncode(String password) {
        setKey(password);
    }
    ...
    public String encodePassword(String rawPass, Object salt) {
        return encryptString(rawPass);
    }

    public boolean isPasswordValid(String encPass, String rawPass, Object salt) {
        return rawPass.equals(decryptString(encPass));
    }
